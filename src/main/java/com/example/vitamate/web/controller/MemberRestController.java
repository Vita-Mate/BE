...
public class MemberRestController {
    ...
    public ApiResponse<String> deleteMember(@PathVariable("memberEmail") String memberEmail){
        return ApiResponse.onSuccess(memberCommandService.deleteMember(memberEmail));
    }
