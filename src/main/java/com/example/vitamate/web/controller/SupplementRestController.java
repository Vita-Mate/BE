...
public class SupplementRestController {
    ...
    private final SupplementQueryServiceImpl memberSupplementService;
    ...
    public ApiResponse<SupplementResponseDTO.TakingSupplementListDTO> getTakingSupplementList(@RequestParam(name = "page") Integer page){
