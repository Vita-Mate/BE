...
public class SupplementRestController {
   ...
   @Operation(summary = "복용중인 영양소 종류와 합산량 조회 API", description = "사용자가 복용중인 영양제에 포함된 영양소의 종류와 양을 조회하는 API 입니다.")
   public ApiResponse<SupplementResponseDTO.IntakeNutrientResultDTO>
