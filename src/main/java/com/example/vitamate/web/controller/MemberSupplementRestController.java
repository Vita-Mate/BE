...
import com.example.vitamate.service.MemberSupplementService.MemberSupplementQueryServiceImpl;
...
public class MemberSupplementRestController {

    private final MemberSupplementQueryServiceImpl memberSupplementService;
    ...
    public ApiResponse<MemberSupplementResponseDTO.TakingSupplementListDTO> getTakingSupplementList(@RequestParam(name = "page") Integer page){

        Page<MemberSupplement> supplementPageDTO = memberSupplementService.getTakingSupplementPage(SecurityUtil.getCurrentUsername(), page);
